...
const OrderModal = ({ showDetails, showEdit, toggleModal, order, onCancel }: any) => {
  ...
  return (
    <>
      ...
      >
        <div className="shadow-7 relative w-full max-w-[800px] min-h-[400px] max-h-[90vh] overflow-hidden scale-100 transform rounded-[15px] bg-white transition-all flex flex-col items-center">
          <button
