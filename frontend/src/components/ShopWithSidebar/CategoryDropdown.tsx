...
const CategoryDropdown = ({ categories, selectedCategoryId, onCategorySelect }: CategoryDropdownProps) => {
    ...
    <div className="bg-white shadow-1 rounded-lg">
      ...
      >
        ...
        <button
          type="button"
          className={`${
            selectedCategoryId === null && "text-blue"
          } group flex items-center justify-between ease-out duration-200 hover:text-blue w-full`}
        ...
        >
          <div className="flex items-center gap-2">
            <div
              className={`cursor-pointer flex items-center justify-center rounded w-4 h-4 border ${
                selectedCategoryId === null ? "border-blue bg-blue" : "bg-white border-gray-3"
              }`}
            >
              <svg
                className={selectedCategoryId === null ? "block" : "hidden"}
                width="10"
                height="10"
                viewBox="0 0 10 10"
                fill="none"
